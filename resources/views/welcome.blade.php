    ...
    <a class="sidebar-brand brand-logo" href="index.html"><img src="assets/images/logo.svg" alt="logo" /></a>
        ...
        <li class="nav-item profile">
            ...
            <div class="profile-pic">
                ...
                <h5 class="mb-0 font-weight-normal">Bilqees Ali Muhammad</h5>
        ...
        <li class="nav-item menu-items">
            ...
            <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">update</a></li>
            </ul>
            </div>
        </li>
        <li class="nav-item menu-items">
            ...
            <span class="menu-title">Check Sales </span>
            </a>
        </li>
        <li class="nav-item menu-items">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="assets/images/faces/face15.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Bilqees Ali Muhammad</p>
